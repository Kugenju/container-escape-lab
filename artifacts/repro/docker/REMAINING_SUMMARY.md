...
| `cves/CVE-2025-52565/run_poc.sh` (`docker 20.10.24 + buildx v0.31.0 + buildkit v0.27.1`) | 0 | pass | 官方远端模板先 `BLOCKED_STAGE=exploit_context_image_unreachable`；切到本地 registry 重放模板后 `PROBE_EXECUTED` |
| `cves/CVE-2025-52881/run_poc.sh` (`docker 20.10.24 + buildx v0.31.0 + buildkit v0.27.1`) | 1 | blocked-stage | 官方模板先 `BLOCKED_STAGE=dockerfile_frontend_image_unreachable`；镜像可达后前移为 `BLOCKED_STAGE=dockerfile_add_from_not_supported`（`ADD --from` 语义不支持） |
...
| CVE-2025-52565 | official Buildx `procfs` template 远端路径受 registry 阻断；通过本地 registry 重放模板后已 `PROBE_EXECUTED` | `artifacts/repro/docker/CVE-2025-52565/buildx-template-20260311-attempt1/`, `artifacts/repro/docker/CVE-2025-52565/local-registry-20260311-attempt2/` |
| CVE-2025-52881 | official Buildx `sysfs` template 远端路径先阻断于 frontend 可达性；改用镜像源后前移为 `dockerfile_add_from_not_supported`（可用 frontend 不支持 `ADD --from`） | `artifacts/repro/docker/CVE-2025-52881/buildx-template-20260311-attempt1/`, `artifacts/repro/docker/CVE-2025-52881/local-registry-frontend120-20260311-attempt3/`, `artifacts/repro/docker/CVE-2025-52881/local-registry-frontend-masterlabs-20260311-attempt6/` |
...
- `artifacts/repro/docker/CVE-2025-52565/local-registry-20260311-attempt2/`
- `artifacts/repro/docker/CVE-2025-52881/buildx-template-20260311-attempt1/`
- `artifacts/repro/docker/CVE-2025-52881/local-registry-frontend120-20260311-attempt3/`
- `artifacts/repro/docker/CVE-2025-52881/local-registry-frontend-masterlabs-20260311-attempt6/`
